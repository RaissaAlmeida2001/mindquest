    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100 flex items-center justify-center p-6 text-gray-800">
      ...
      >
        ...
        <div className="space-y-4">
          <input placeholder="Usuário ou Email" className="w-full p-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-green-400" />
          <input type="password" placeholder="Senha" className="w-full p-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-green-400" />
          <button onClick={() => navigate("/humor")} className="w-full bg-green-500 text-white font-bold py-4 rounded-2xl shadow-lg hover:bg-green-600 transition-all active:scale-95">
            Entrar no MindQuest
          </button>
        </div>
